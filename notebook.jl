...
# ╔═╡ 01cd2339-0699-44ce-a8c4-5330a8dd54a7
begin
	using DataFrames
	using CSV
end

# ╔═╡ cd169d46-f4a3-4f3f-b960-906fc491a1d8
using Plots  # This will install plots

# ╔═╡ 00f754ae-d60c-443a-b52e-0e0b1fc92d8f
using PlutoUI

# ╔═╡ 6ce7006b-9800-4ab6-b51a-2d1b8695b356
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 2ddb8ab7-f79c-4260-a0fd-9ac7a1a8adf5
df.Country_code === df[!, "Country_code"]

# ╔═╡ afb517e0-006a-48b9-bd60-cb83cbdbeb77
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 3b50586a-d705-43c0-b699-965e7b4e2c45
# ╠═╡ disabled = true
#=╠═╡
sg_data = filter(:Country_code => equals_sg, df)
  ╠═╡ =#

# ╔═╡ 105c7942-014a-4d3e-8baa-0c9e71b7dede
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 0065f50c-b40f-4a6f-8fca-0519144da37b
dates = sg_data[!, "Date_reported"]

# ╔═╡ 060f8fed-981f-4a65-a7c5-e90ca01f2432
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 59b7f161-c5a1-4025-b025-9474c44521dc
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 183c1574-7068-49c2-83e8-baa0df188ca4
...
# ╔═╡ a3d1ae26-d231-4e94-a30a-6a1ab164e434
@bind slider_value Slider(0:10:1000)

# ╔═╡ 27a09590-7934-48ef-bccb-bd099be63574
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ a555d9d5-48f4-442a-be28-5632587cd5bd
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ ff8a47a3-24cc-4b74-8549-746d32b73232
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ e350b288-0c11-4998-9e80-332d07a2259d
...
manifest_format = "2.0"
project_hash = "0f010026e625b6a70e8c5dc3ca3747002f031550"
